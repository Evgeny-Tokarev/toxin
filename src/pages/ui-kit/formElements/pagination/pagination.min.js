    ...
    $.fn[pluginName] = function (options) {
        ...
        var pagination = {
            ...
            render: function (isBoot) {
                ...
                if (rangeStart <= 1) {
                    rangeStart = 1;
                    rangeEnd = Math.min(pageRange + 1, totalPage);
            ...
            go: function (number, callback) {
                ...
                postData[alias.pageSize ? alias.pageSize : 'pageSize'] =
                    pageSize;
            ...
            filterDataByLocator: function (dataSource) {
                ...
                if (Helpers.isObject(dataSource)) {
                    ...
                    if (!filteredData) {
                        ...
                        throwError(
                            'dataSource.' + locator + ' must be an Array.'
                        );
                    }
                }
            ...
            parseDataSource: function (dataSource, callback) {
                ...
                if (Helpers.isObject(dataSource)) {
                    callback(
                        (attributes.dataSource =
                            self.filterDataByLocator(dataSource))
                    );
